...
각 TODO는 다음 형식으로 작성하세요:

제목: 구체적이고 실행 가능한 작업 (예: "수학 미적분 기출문제 5회분 풀기", "영단어 100개 암기 및 복습")
설명: 왜 이 작업이 필요한지, 어떻게 수행할지 구체적으로 설명 (2-3문장)
우선순위: 높음/중간/낮음
예상시간: 실제 소요 예상 시간 (예: "2시간", "30분")
카테고리: 공부/복습/문제풀이/암기/정리/모의고사 중 하나

**중요 원칙:**
- 제목에는 접두어 없이 바로 작업 내용만 작성 (❌ "제목:", "**제목:**" 사용 금지)
